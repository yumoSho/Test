...
@Controller
@RequestMapping("/admin/accessoy")
public class AdminAccessoyController {
    ...
    public Message savePackages(ProductPackage productPackage, String goodsIds, String productIds){
        if(null!=productPackage && null !=productPackage.getId()){
            productPackage.setType(ProductPackage.PACKAGE_TYPE_ACCESSOY);
    ...
    public ModelAndView edit(@PathVariable("id")Long id) {
        ...
        mav.setViewName("admin/accessoy/edit");
        return mav;
    }
