 ...
 */
@Controller
@RequestMapping("/admin/rtMoney")
public class RtMoneyController extends BaseController{
	private final static String PATH = "admin/rtMoney/";
...
//		Properties conf = PropertiesUtil.getConfig(Constants.RT_MONEY_CONF);
//		map.put("conf",conf);
    ...
    public String save(@RequestParam Map params,Dictionary dictionary){
		...
		PropertiesUtil.writeProperties(properties,Constants.RT_MONEY_CONF,"返利协议");*/
