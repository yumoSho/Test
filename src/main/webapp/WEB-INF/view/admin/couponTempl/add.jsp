...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="editPage" style="height:800px;">
            <form id="form" action="${ctx}/admin/couponTempl/save" method="post">
                ...
                <table class="table-module01" cellpadding="0" cellspacing="0" id="tbl">
                    ...
                    <tr>
                        ...
                        <td>
                            <%--<input type="number" name="discount" class="required" maxlength="30"/>--%>
<span id="discount-spinner" class="spinner">
        <input id="discount" name="discount" class="input required" value="">
        <span class="spin-buttons">
            ...
            <span class="btn-down"></span>
                    ...
                    <tr>
                        ...
                        <td>
                            <%--<input type="number" name="minPrice" class="required" maxlength="30"/>--%>
<span id="sort-spinner" class="spinner">
        <input id="sortNum" name="minPrice" class="input required" value="">
        <span class="spin-buttons">
            <span class="btn-up"></span>
            <span class="btn-down"></span>
        </span>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="autoSend" class="autoSend" checked value="1"/> 是
                            <input type="radio" name="autoSend" class="autoSend" value="0"/> 否

                        </td>
                    </tr>

                    <tr class="autoSend">
                        <th width="130" align="right">自动发放最低金额：<b class="color-red">*</b></th>
                        <td>
                            <%--<input type="number" name="autoMinPrice" class="required" maxlength="30"/>--%>

                            <span id="autoMinPrice-spinner" class="spinner">
        <input id="autoMinPrice" name="autoMinPrice" class="input required" value="">
        <span class="spin-buttons">
            <span class="btn-up"></span>
            <span class="btn-down"></span>
        </span>
                    ...
                    <tr class="autoSend">
                        <th width="130" align="right">自动发放最大金额：<b class="color-red">*</b></th>
                        <td>
                            <%--<input type="number" name="autoMaxPrice" class="required" maxlength="30"/>--%>
<span id="autoMaxPrice-spinner" class="spinner">
        <input id="autoMaxPrice" name="autoMaxPrice" class="input required">
        <span class="spin-buttons">
            <span class="btn-up"></span>
            <span class="btn-down"></span>
        </span>
