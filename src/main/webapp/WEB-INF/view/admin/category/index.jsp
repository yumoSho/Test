...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="position">
            ...
            <a href="${ctx}/admin/category/index" title="品牌管理">商品分类</a> &gt;
            列表
        </div>
        <!-- //End 当前位置 -->
        <div class="listPage">
...
<script type="text/javascript" src="${ctx}/js/lib/jqgrid/src/grid.treegrid.js"></script>
<script type="text/javascript" src="${ctx}/js/admin/product/category.js"></script>
