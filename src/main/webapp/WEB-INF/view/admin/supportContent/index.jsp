...
<script type="text/javascript">
    ...
    var $g = $('#datagrid').jqGrid({
        url: 'list',
        datatype: 'json',
        colNames: ['操作', 'id','名称','分类','排序','添加时间','最新修改时间'],
        colModel: [
            {
            ...
            {name: 'title', index: 'tu.title', template: 'text', sortable:false,search:true},
            {name: 'supportCategory.name', index: 'tu.name', template: 'text', sortable:false,search:true},         
	        ...
	        {name: 'lastModifiedDate', template: 'date',search:false, formatter:"date", formatoptions: {newformat:'Y-m-d H:m:s'}}
