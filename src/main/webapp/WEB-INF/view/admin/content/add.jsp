        ...
        <div class="editPage" style="height:800px;">
            ...
            <table class="table-module01" cellpadding="0" cellspacing="0" id="tbl">
                ...
                <tr>
                    ...
                    <td >
                      ...
                      <c:forEach items="${dictionaries_pt}" var="dictionary" >
				          <option value="${dictionary.id }">${dictionary.dicName }</option>
                                        ...
                                        <ul class="upload-queue" id="upload-queue">
                                            <li>
                                                <c:if test="${not empty contentManagement.image}">
                                                    <input type="hidden" name="image" value="${contentManagement.image}" data-value="${ctx}/${contentManagement.image}"/>
                                                </c:if>
                ...
                <tr>
                    ...
                    <td >
                           <textarea id="editor_" name="content" rows="" cols=""></textarea>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            submitHandler: function(form){
            	...
            	if(isExist){
            		Glanway.Messager.alert("提示", "该分类内容已添加")
            		return;
            	}
