...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="position">
            ...
            <a href="${ctx}/admin/commonPro/index" title="">常见问题管理</a> &gt;
            编辑
        </div>
        <!-- //End 当前位置 -->
        <div class="editPage" style="height:800px;">
            <form id="form" action="${ctx}/admin/commonPro/update" method="post">
                ...
                <tr>
                    <th width="130" align="right">是否显示：</th>
                    <td>
                        <input name="display" value="1" class="text_sketch" type="checkbox" <c:if test="${supportContent.display}">checked</c:if> > 是&nbsp;
                    </td>
                </tr>
                 <tr>
...
$(function(){
    $(".btn-cancel-wrap input").click(function() {
        window.location.href = "${ctx}/admin/commonPro/index";
    });
