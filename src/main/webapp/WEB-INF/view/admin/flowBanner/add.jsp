        ...
        <div class="editPage" style="height:800px;">
            ...
            <table class="table-module01" cellpadding="0" cellspacing="0" id="tbl">
                ...
                <tr>
                    ...
                    <td >
                        <input type="text" name="beginDate" readonly id="beginDate" style="border:1px solid #d4d4d4;width: 195px;height:25px;padding-left: 4px" class="Wdate valid" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd 00:00:00', maxDate:'#F{$dp.$D(\'endDate\')||\'2099-12-31\'}'})">
                    </td>
                </tr>
                <tr>
                    <th width="130" align="right">有效期结束：<b class="color-red">*</b></th>
                    <td >
                        <input type="text" readonly name="endDate" id="endDate" style="border:1px solid #d4d4d4;width: 195px;height: 25px;padding-left: 4px" class="Wdate valid" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd 23:59:59', minDate:'#F{$dp.$D(\'beginDate\')}',maxDate:'2099-12-31'})">
                    </td>
                </tr>
                <tr>
                    <th width="130" align="right">是否启用：<b class="color-red">*</b></th>
                    <td >
                        <input type="checkbox" name="isShow" value="1" checked="checked"> 是
                    </td>
                </tr>
