...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="editPage" style="height:800px;">
            <form id="form" action="${ctx}/admin/category-label/update" method="post">
                <input type="hidden" name="TOKEN" value="${TOKEN}">
                <input type="hidden" name="id" value="${categoryRecommend.id}">
                <table class="table-module01" cellpadding="0" cellspacing="0" id="tbl">
                <tbody>
                <tr>
                    <th width="130" align="right">标签名称：<b class="color-red">*</b></th>
                    <td >
                      <input type="text" name="title" value="${categoryRecommend.title}"/>
                ...
                <tr>
                    ...
                    <td >
                           <input name="url"  class="text_sketch" value="${categoryRecommend.url}" type="text">
