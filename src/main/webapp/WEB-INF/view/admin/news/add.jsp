        ...
        <div class="editPage" style="height:800px;">
            ...
            <table class="table-module01" cellpadding="0" cellspacing="0" id="tbl">
                ...
                <tr>
                    ...
                    <td >
                           <textarea id="editor_" name="content" style="height: 400px;"></textarea>
                ...
                <tr>
                    ...
                    <td>
                        <input name="isShow" value="1" class="text_sketch" type="checkbox" checked> 显示&nbsp;
                        <input name="isHot" value="1" class="text_sketch" type="checkbox"> 首页推荐
                    </td>
                </tr>
                <tr>
