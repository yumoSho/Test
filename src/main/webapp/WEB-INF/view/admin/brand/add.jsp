                ...
                <form action="save" method="post">
                    <table class="table-module01" cellpadding="0" cellspacing="0">
                        ...
                        <%--<tr>
                            ...
                            <td >
                                ...
                                <ul class="upload-list" flag="pro-img">
                                    <li class="js-plupload" name="logo" id="img1"
                                        ...
                                        <ul class="upload-queue" id="upload-queue">
                                            <li>
                                                <c:if test="${not empty brand.logo}">
                                                    <input type="hidden" name="logo" value="${brand.logo}" data-value="${ctx}/${brand.logo}"/>
                                                </c:if>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <label><input type="radio" name="enabled" value="1" checked style="margin-top: 10px;">是</label>
                                <label><input type="radio" name="enabled" value="0" style="margin-top: 10px;">否</label>
                            </td>
                        </tr>
                        <tr>
                            <th width="130" align="right" valign="top">是否推荐：<b class="color-red">*</b></th>
                            <td valign="top">
                                <label><input type="radio" name="recommend" value="1"  style="margin-top: 10px;">是</label>
                                <label><input type="radio" name="recommend" value="0" checked  style="margin-top: 10px;">否</label>
