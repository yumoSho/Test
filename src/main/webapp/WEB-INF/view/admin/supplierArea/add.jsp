	...
	<div class="content">
	    ...
	    <div style="width:100%;height:600px;"> 
	        <div data-options="region:'center',split:true" title="物流区域信息" style="height: 600px; width: 80%">
	            ...
	            <form id="fromSave" action="${ctx}/admin/supplierArea/save" method="post">
	                <table class="table-module01" cellpadding="0" cellspacing="0" id="tbl">
	                    <tbody>
	                    <tr>
	                        <th width="130" align="right">邮寄地区名称：<b class="color-red">*</b></th>
	                        <td>
	                            <input type="text" name="areaName" maxlength="30" style="width: 400px;height: 24px;" id="areaName"/>
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <input type="text" name="price" maxlength="20" style="width: 200px;height: 24px;" id="price"/>
	                         <%--   <span class="errorTip"></span>--%>
	                        </td>
	                    </tr>
