...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="position">
            ...
            <a href="${ctx}/admin/rechargeRule/index" title="充值返利规则管理">充值返利规则管理</a> &gt;
            列表
        </div>
        <!-- //End 当前位置 -->
        <div class="listPage">
...
<script type="text/javascript">
    ...
    var $g = $('#datagrid').jqGrid({
        url: 'list',
        datatype: 'json',
        colNames: ['操作', 'id','充值金额','返利百分比','排序','添加时间'],
        colModel: [
            {
            ...
            {name: 'money', index: 'tu.money', template: 'text', sortable:false,searchoptions: {sopt: ["eq"]}},
	        {name: 'discount', index: 'tu.discount', template: 'text', sortable:false,searchoptions: {sopt: ["eq"]},formatter:function(cell,row){
                return cell + '%';
            }},
