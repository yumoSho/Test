...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="editPage" style="height:800px;">
            <form id="form" action="${ctx}/admin/rechargeRule/update" method="post">
                <input type="hidden" name="TOKEN" value="${TOKEN}">
                <input type="hidden" name="id" value="${rechargeRule.id}">
                ...
                <tr>
                    ...
                    <td>
                          <span id="money-spinner" class="spinner">
                                <input id="money" name="money" class="input" value="${rechargeRule.money}">
                ...
                <tr>
                    ...
                    <td>
                          <span id="discount-spinner" class="spinner">
                                <input id="discount" name="discount" class="input" value="${rechargeRule.discount}">
                                <span class="spin-buttons">
                                    <span class="btn-up"></span>
                                    <span class="btn-down"></span>
                                </span>
                ...
                <tr>
                    ...
                    <td>
                          <span id="sort-spinner" class="spinner">
                                <input id="sortNum" name="sortNum" class="input" value="${rechargeRule.sortNum}">
                                <span class="spin-buttons">
                                    <span class="btn-up"></span>
                                    <span class="btn-down"></span>
                                </span>
