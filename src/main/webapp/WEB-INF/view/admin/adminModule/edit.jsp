    ...
    <div class="content">
        ...
        <div class="editPage" style="height:800px;">
            ...
            <div <%--class="editPage"--%> data-options="region:'center',split:true" title="基础信息">
                <form id="fromSave" action="${ctx}/admin/module/update" method="post">
                    <table class="table-module01" cellpadding="0" cellspacing="0" id="tbl">
                        <tbody>
                        <tr>
                            <th width="130" align="right">模块名：<b class="color-red">*</b></th>
                            <td>
                                <input id="moduleId" type="hidden" name="id" value="${module.id}" >
                                <input id="moduleName" type="text" name="name" maxlength="20" value="${module.name}"/>
                        ...
                        <tr>
                            ...
                            <%--<td>
                                <input type="text" name="sort" value="${module.sort}">
                                <span class="errorTip" id="nameSpan"></span>
                            </td>--%>

                            <td valign="top">
                            <span id="sort-spinner" class="spinner">
                                <input id="sort" name="sort" class="input" value="${module.sort}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="remark"  value="${module.remark}">
                                <span class="errorTip"></span>
                            </td>
                        </tr>
                        <tr>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $.validator.addMethod("isModuleExists", function(value, element){
                var exists = 0;
                moduleIdAndName = [$("#moduleId").val(),$("#moduleName").val()];
                $.ajax({
                    url: '${ctx}/admin/module/hasAnnotherModule',
                    type: 'post',
                    async: false,
                    data: {"moduleIdAndName": moduleIdAndName},
                    dataType: 'json',
