            ...
            <form action="../update" method="post">
                <table class="table-module01" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" name="validateImg" value="${not empty m.activityImgPath?'1':''}">
                                    ...
                                    <ul class="upload-queue" id="upload-queue">
                                        <li>
                                            <c:if test="${not empty m.activityImgPath}">
                                                <input type="hidden" name="logo" value="${m.activityImgPath}" data-saved-url="${ctx}/${m.activityImgPath}"/>
                                            </c:if>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="validateImg1" type="hidden" value="${not empty m.activityBannerPath?'1':''}">
                            <div class="uploader-1" id="">
                                ...
                                <div class="upload-single">
                                    ...
                                    <ul class="upload-queue" id="upload-queue-banner">
                                        <li>
                                            <c:if test="${not empty m.activityBannerPath}">
                                                <input type="hidden" name="logo" value="${m.activityBannerPath}" data-saved-url="${ctx}/${m.activityBannerPath}"/>
                                            </c:if>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="startTime" name="startDate" class="Wdate" type="text"
                                   value="<fmt:formatDate value="${m.startDate}" type="date" pattern="yyyy-MM-dd  HH:mm:ss"/>"
                            ...
                            <input id="endTime" name="endDate" class="Wdate" type="text"
                                   value="<fmt:formatDate value="${m.endDate}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>"
