                        ...
                        <table class="table-module01 table-module02" id="acce-list">
                            ...
                            <tr class="packagesTr">
                                <td><div class="em_list" data-composes="productId">
                                    <h2 class="clearfix">
                                        <span class="fl">套餐名称：<b>${productPackage.name}</b></span>
                                        <span style="margin-left: 100px;">套餐价：<b>${productPackage.saveMoney}</b></span>
        ...
        <div id="addPackagesDlg" style="display: none">
            <div class="tab1" id="addPackagesDiv">
                <form id="combine-Form">
                    <h2
                            style="border-bottom: 1px solid #ddd; padding-left: 2px; margin-bottom: 10px;">添加套餐产品</h2>
                    <table class="table-module01" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="easyui-textbox" type="text" id="saveMoney" name="saveMoney" value="${productPackage.saveMoney}"/>
                                <span class="errorTip"></span></td>
                        </tr>
