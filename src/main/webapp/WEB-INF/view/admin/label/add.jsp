                ...
                <form action="save" method="post">
                    <table class="table-module01" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td valign="top"><input type="text" name="labelName"></td>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <label><input type="radio" name="disabled" value="0" checked style="margin-top: 10px;">是</label>
                                <label><input type="radio" name="disabled" value="1" style="margin-top: 10px;">否</label>
                            </td>
                        </tr>
