...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="position">
            ...
            <a href="${ctx}/admin/memberDividend/index" ; title="会员推荐提成设置">会员推荐提成设置</a> &gt;
        </div>
        <!-- //End 当前位置 -->
        <div class="editPage" style="height:800px;">
            <form id="form" action="${ctx}/admin/memberDividend/save" method="post">
                    ...
                    <tr >
                        <td colspan="2" style="padding-left: 80px">
                            <table id="discount">
                                ...
                                <c:forEach items="${mdList}" var="gd" varStatus="index">
                                    <tr index = "${index.index}">
                                        ...
                                        <td>分类的商品时，推荐人可以获得</td>
                                        <td>
                                            <input type="number" step="0.1" min="0" max="999" name="discount[${index.index}]" value="${gd.discount}" style="width: 120px;" class="required">
                                        </td>
                                        <td>
                                            %提成比例
    ...
    <script type="text/html" id="rowTmpl">
        <tr index = "<!=index!>">
            ...
            <td>分类的商品时，推荐人可以获得</td>
            <td>
                <input type="number" step="0.1" min="0" max="999" name="discount[<!=index!>]" style="width: 120px;" class="required">
            </td>
            <td>
                %提成比例
                <a href="javascript:void(0)" onclick="rowRM(this)">删除</a>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $(".btn-cancel-wrap input").click(function () {
                window.location.href = contextPath + "/admin/memberDividend/index";
            });
            if($("#discount tr").size() < 1){
                rowAdd();
            }
