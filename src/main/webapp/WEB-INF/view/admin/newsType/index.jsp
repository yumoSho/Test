...
<script type="text/javascript">
    ...
    var $g = $('#datagrid').jqGrid({
        ...
        colModel: [
            ...
            {name: 'name', index: 'tu.name', template: 'text', sortable:false,searchoptions: {sopt: ["cn"]}},
            {
                name: 'activated', index: 'tu.activated', template: 'select', stype: 'select',
                width: 150,
