...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="editPage" style="height:800px;">
            <form id="form" action="${ctx}/admin/advertisement/update" method="post">
                    ...
                    <td >
                        <select id="dicId" name="deviceType" data-placeholder="请选择" class="select chosen-select ni">
                            ...
                            <c:forEach items="${dictionaries_pt}" var="pt" >
                                <option value="${pt.dicCode }" <c:if test="${advertisement.deviceType==pt.dicCode}">selected="selected"</c:if>>${pt.dicName }</option>
                            </c:forEach>
                        </select>
                    ...
                    <td >
                        ...
                        <select id="ggId" name="pos" data-placeholder="请选择" class="select chosen-select ni">
                            ...
                            <c:forEach items="${posList}" var="pos" >
                                <option value="${pos.dicCode }" <c:if test="${advertisement.pos==pos.dicCode}">selected="selected"</c:if>>${pos.dicName }</option>
                            </c:forEach>
                        </select>
                        <label for="dicId" generated="true" class="error"></label>
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" name="validateImg" value="${not empty advertisement.image?'1':''}"/>
                ...
                <tr>
                    ...
                    <td >
                           <input  name="field1" value="${advertisement.field1}" class="text_sketch" type="text">
                ...
                <tr>
                    ...
                    <td >
                        <input type="checkbox" name="isShow" value="1" <c:if test="${advertisement.isShow == 1}">checked</c:if> > 是
                    </td>
                </tr>
