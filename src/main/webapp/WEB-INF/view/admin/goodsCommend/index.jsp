...
<script type="text/javascript">
    ...
    var $g = $('#datagrid').jqGrid({
        url: 'list',
        datatype: 'json',
        colNames: ['操作', 'id','分类','所属楼层','排序','添加时间'],
        colModel: [
            {template: 'actions2', width: 100},
    		{name: 'id', index: 'id', hidden: true, key: true},
    		{name: 'category.name', index: 'tc.name', template: 'text', },
            {name: 'floor', index: 'floor', template: 'text'},
            {name: 'sort',index: 'tam.sort',template: 'text'},
