        ...
        <div class="main">
            <div id="regiseDealDiv">
                <div class="samePadding" id="samePadding">
                    <p class="registTitle">
                        <a href="${ctx}/reg" class="fleft">手机注册</a>
                        <a href="#" class="fleft on">邮箱注册</a>
                    </p>
                    <form class="formDiv registForm" id="mailForm">
                        ...
                        <ul class="displayFrame">
                            <li>
                                ...
                                <input type="text"  placeholder="4-20位字符组合" name="memberName" id="imemberName" maxlength="20">
                            </li>
                            <li>
                                <span class="spanWidth"><i class="redStar">*</i>邮箱号：</span>
                                <input type="text"  placeholder="请输入邮箱号" name="email" id="mail" />
                            </li>
                            <li class="heightBtn">
                        ...
                        <input type="button" value="注册" class="sameBtn" id="isubmit" />
                    </form>
...
<script src="${ctx}/js/mobile/loginAndRegister/registerByMail.js"></script>
</html>
