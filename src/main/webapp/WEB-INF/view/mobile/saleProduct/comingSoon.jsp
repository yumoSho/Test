...
<body>
    ...
    <div class="wrap">
        ...
        <div class="main">
            <div class="tabBtn">
                <a href="${ctx}/mobile/timed-panic-buying/index">正在进行</a>
                <i></i>
                <a href="javascript:void(0);" class="on">即将开始</a>
            </div>
            <div class="information samePadding pinterest">
                ...
                <div class="informationDiv clearfix">
                    <a href="${ctx}/detail/${discount.goods.id}?goodsFrom=3&oid=${discount.id}" class="informationImg fleft">
                        <img src="${ctx}/${discount.goods.image}" />
                    </a>
                    <div class="informationRight fleft">
                        <p class="colorP">&yen; <span class="sizeP"> <fmt:formatNumber value="${discount.goods.promotePrice}" type="currency" pattern="0.00"/></span></p>
                        <div class="overflow1">
                            <div><a href="${ctx}/detail/${discount.goods.id}?goodsFrom=3&oid=${discount.id}">${discount.goods.title}</a></div>
                            <p>${discount.goods.intro}</p>
                        </div>
                        <div class="countDown">
                            <span class="time" data-endtime="<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${discount.startDate}"/>"></span>
                        </div>
                    ...
                    <div class="mask">
                        <img src="${ctx}/images/mobile/maskImg.png" />
                    </div>
                </div>
                </c:forEach>
            </div>
    ...
    <script id="moreList" type="text/html">
        <div class="informationDiv clearfix">
            <a href="${ctx}/detail/<!=gid!>?goodsFrom=3&oid=<!=id!>" class="informationImg fleft">
                <img src="${ctx}/<!=img!>" />
            </a>
            <div class="informationRight fleft">
                ...
                <div class="overflow1">
                    <div><a href="${ctx}/detail/<!=gid!>?goodsFrom=3&oid=<!=id!>"><!=title!></a></div>
                    <p><!=intro!></p>
                </div>
                <div class="countDown">
            ...
            $(window).scroll(function () {
                ...
                if (scrollTop + windowHeight == scrollHeight) {
                    ...
                    $.ajax({
                        ...
                        type:"get",
                        data: {page:page,pageSize:pageSize,provinceId:0,type:1},
                        traditional: true,
