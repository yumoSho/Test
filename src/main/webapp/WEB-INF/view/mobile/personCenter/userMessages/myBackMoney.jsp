                ...
                <div class="rechangeHistoryText">
                    ...
                    <c:forEach items="${balancePaymentDetails.data }" var="balancePaymentDetail">
                        <table border="1">
                            <tr>
                                <td>购买用户</td>
                                <td>${balancePaymentDetail.consumeMember.memberName }</td>
                            </tr>
                            <tr>
                                <td>返现金额</td>
                            ...
                            <tr>
                                <td>下单时间</td>
                                <td><fmt:formatDate value="${balancePaymentDetail.createdDate}" type="both"/></td>
                            </tr>
                        </table>
                    </c:forEach>
                    </div>
    ...
    <script>
        ...
        $(window).scroll(function () {
            ...
            if (scrollTop + windowHeight == scrollHeight) {
                ...
                $(".load").css({opacity: 1});
                $.ajax({
                    url:"${ctx}/mobile/person-center/myBackMoney/list",
                    type:"get",
                    ...
                    if(data){
                        $.each(data,function(i,e){
                            var a={
                                id: e.id,
                                memberName: e.consumeMember.memberName,
                                amount: e.amount,
