...
<head>
    ...
    <title>${contentManagement.dictionary.dicName}-${seo.title}</title>
    ...
    <div class="wrap">
        ...
        <div class="main samewidth">
            ...
            <div class="positionWrap">
                <div class="position">
                    <span>您所在当前位置：</span>
                    <a href="${ctx }/">首页</a><span class="forGt"> &gt;</span><span>${contentManagement.dictionary.dicName}</span>
                </div>
            </div>
            <!--详情标题部分-->
            <div class="detailTitleWrap">
                <h1>${contentManagement.dictionary.dicName}</h1>
               <%--  <div class="detailDate">发表时间：<span><fmt:formatDate value="${contentManagement.createdDate}" type="date"/></span></div> --%>
            </div>
            <!--详情内容部分-->
