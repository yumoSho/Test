                ...
                if ('thumb' == listMode) {
                    ...
                    img.onload = function () {
                        ...
                        if($('#ImageIcon')){
                            ...
                            var v = "#Canvas_"+targetId+" p";
                           /* $(v).append("<img class='iimg' style='width: 65px;height:65px;' src='"+img.src+"' />");*/
                            var n = $(v).children("span").size();
                            if(n < 5){
                                $(v).append("<span style='position: relative;float: left;z-index: 10;'><img class='iimg' style='width: 65px;height:65px;margin-right: 7px;' src='"+img.src+"' /><a href='javascript:void(0);' class='delete' style='position: absolute;top: 0;left: 0; color: #fff;'>删除</a></span>");
                            }
