...
;window.parseUpload = (function ($, plupload, o) {
    ...
    function parseUpload(i, el) {
        ...
        //
            ...
            uploadUrl = hasUrl ? listOpts[3].substring(1) : ('img' == uploadName ? '/storage/images/preupload' : '/storage/files/preupload'),
        ...
        //
            ...
            opts = {
                ...
                flash_swf_url : (window.contextPath || window.ctx||'') + '/js/lib/plupload-2.1.2/Moxie.swf', //swf文件，当需要使用swf方式进行上传时需要配置该参数
                silverlight_xap_url : (window.contextPath || window.ctx||'') + '/js/lib/plupload-2.1.2/Moxie.xap', //silverlight文件，当需要使用silverlight方式进行上传时需要配置该参数
...
//				$tip.show().html(speed * 1000);
        ...
        uploader.bind('Error', function (up, err) {
            ...
            message += "<i>" + details + "</i>";
            /** 于2016-7-1 用于商禾项目 文件类型不匹配 提示信息修改  ---LiuJC
            $('.upload-error').html(message);*/
            Glanway.Messager.alert('错误信息',message)
